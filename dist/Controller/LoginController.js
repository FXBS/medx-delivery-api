    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 14:
          ...
          console.log("User Password:", _user['passwordd']);
          // rest of the code
          _context.next = 26;
          break;
        case 22:
          ...
          console.error("Error executing database query:", _context.t0);
        ...
        case 7:
          ...
          res.json({
            ...
            user: (_user2 = {
              ...
              selectedPincodes: user.selectedPincodes,
              image: user.image
            }, _defineProperty(_user2, "phone", user.phone), _defineProperty(_user2, "email", user.email), _defineProperty(_user2, "rol_id", user.rol_id), _defineProperty(_user2, "notification_token", user.notification_token), _user2),
            token: token
          });
          _context2.next = 15;
          break;
