...
var _JwToken = require("../Lib/JwToken.js");
...
var PartnerController = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          partnerId = req.query.partnerId; // Assuming the partnerId is passed as a query parameter
          ...
          _context.next = 6;
          return _mysql["default"].query(query, [partnerId]);
        case 6:
          _yield$pool$query = _context.sent;
          _yield$pool$query2 = _slicedToArray(_yield$pool$query, 1);
          partnerDetails = _yield$pool$query2[0];
        ...
        case 11:
          ...
          token = (0, _JwToken.generateJsonWebToken)(partnerId); // Replace with your token generation logic
  ...
  return function PartnerController(_x) {
